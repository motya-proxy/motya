...
Motya has three sources of configuration:
...
users of Motya to provide files as part of a regular deployment process. Currently,
...
It is not expected that Motya will make all configuration options available
