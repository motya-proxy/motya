...
This announcement covers the v0.2.1 release of Motya. This is a minor release that
switches to the v0.2.0 crates.io release of `pingora`, in order to allow for the
release of `motya` on crates.io. You can now find [`motya` on crates.io].

[`motya` on crates.io]: https://crates.io/crates/motya/0.2.1
